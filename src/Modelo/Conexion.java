...
public class Conexion {
    ...
    public static final String username = "root";//"appsyco";
    public static final String password =  "root";//"@frente21";
    */
    ...
    public static Connection getConnection() {
        ...
        try {
            Object obj = new JSONParser().parse(new FileReader("C:\\program files\\SYCO\\config.json"));
